...
def build_single_shot_spec_prompt(
    ...
    return (
        ...
        "- Split multi-action capability statements into separate rows when one actor must do several actions such as add, update, and close.\n"
        ...
        "- Privacy or security prohibitions such as not exposing personal, birth date, contact, health, or child information are non_functional_requirement, not note.\n"
        "- Mobile usability should usually be a non_functional_requirement; also add an open_question only when the measurable target is unclear.\n"
